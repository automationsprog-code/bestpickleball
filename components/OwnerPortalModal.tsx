...
import { X, ShieldCheck, QrCode, Search, User, CheckCircle2, Save, RefreshCw, AlertCircle, Lock, KeyRound, LogOut } from 'lucide-react';
        ...
        <div className="bg-slate-50 px-6 py-4 border-b border-slate-200 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 font-medium">BEST Inc. Balamban Court Reservations & QR Management</p>
            </div>
          </div>
